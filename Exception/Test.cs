    ...
    class Test
    {
        static void Main(string[] args)
        {
            InvalidRangeException<int> someIntExeption =
                new InvalidRangeException<int>("Number outside the interval [1,100] was entered", 1, 100);
            ...
            InvalidRangeException<DateTime> someDateExpection =
                new InvalidRangeException<DateTime>("The date isn't in the range from 1980 to 2013!"
